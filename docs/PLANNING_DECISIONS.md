...
Gunakan `docs/DASHBOARD_INTEGRATION_PLAN.md` sebagai acuan integrasi.
...
- rencana implementasi skema inti dicatat di `docs/CORE_SCHEMA_PLAN.md`
- urutan migration dan scaffold migration dicatat di `docs/MIGRATION_PLAN.md` dan `database/migrations`
- seed awal dicatat di `docs/SEED_PLAN.md` dan `database/seeds`
